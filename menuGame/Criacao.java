...
public class Criacao extends JFrame {
    ...
    public Criacao(){
        ...
        ImageIcon[] personagens = new ImageIcon[2];
            ...
            personagens[1] = new ImageIcon(getClass().getResource("/cacadora.png"));
        ...
        JButton masc = new JButton("CAÇADOR");
            ...
            masc.addActionListener(new ActionListener(){
                ...
                public void actionPerformed(ActionEvent e){
                    Image personagem = personagens[0].getImage().getScaledInstance(150,120, Image.SCALE_SMOOTH);
                    ImageIcon selecao = new ImageIcon(personagem);
                    selectLabel.setBounds(180,110,150,120);
        ...
        JButton fem = new JButton("CAÇADORA");
            ...
            fem.addActionListener(new ActionListener(){
                @Override
                public void actionPerformed(ActionEvent e){
                    Image personagem = personagens[1].getImage().getScaledInstance(200,200, Image.SCALE_SMOOTH);
                    ImageIcon selecao = new ImageIcon(personagem);
                    selectLabel.setBounds(150,40,200,200);
                    selectLabel.setIcon(selecao);
                    setVisible(true);
                }
            });
